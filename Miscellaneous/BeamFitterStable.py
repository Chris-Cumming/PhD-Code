# -*- coding: utf-8 -*-
"""
Created on Fri Oct  4 16:48:06 2024
...
if __name__ == '__main__':
    ...
    imagePath = r"Z:\Tweezer\People\Alex\Organisation\Grad Course\Beam Images"
    os.chdir(imagePath)
    plt.close('all')
    p = profile(imagePath, pixelSize=3.45e-3)#5.2e-3 # 5.86
    
   # Z,waist_x,waist_y=p.analyseBeamProfile('hyperbola',plot_all=True,angle=0)
    p.plotSingle('Test_Image.bmp',angle=0)
